cassini: cassini.o commandline.o string2.o timing-text-io.o write-request.o read-request.o
	gcc cassini.o commandline.o string2.o timing-text-io.o write-request.o read-request.o -o cassini
