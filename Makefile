...
saturnd: saturnd.o execute-request.o string2.o timing-text-io.o commandline.o task.o
	gcc saturnd.o execute-request.o string2.o timing-text-io.o commandline.o task.o -o saturnd
